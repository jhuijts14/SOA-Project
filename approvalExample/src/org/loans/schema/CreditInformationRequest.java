 ...
 */
            ...
            /**
            *  CreditInformationRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CreditInformationRequest
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CreditInformationRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CreditInformationRequest",
    ...
    public static class Factory{
        ...
        */
        public static CreditInformationRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreditInformationRequest object =
                new CreditInformationRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CreditInformationRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreditInformationRequest)org.loans.schema.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
