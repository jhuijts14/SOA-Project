                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                           ...
                                           localRepairTime.serialize(new javax.xml.namespace.QName("http://localhost:8080/SOAProject/services/CostCalculationService","RepairTime"),
                                               xmlWriter);
                                       ...
                                       if (localBikePart!=null){
                                            for (int i = 0;i < localBikePart.length;i++){
                                                if (localBikePart[i] != null){
                                                 localBikePart[i].serialize(new javax.xml.namespace.QName("http://localhost:8080/SOAProject/services/CostCalculationService","BikePart"),
                                                           xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetRepairCostType".equals(type)){
                                ...
                                return (GetRepairCostType)localhost.soaproject.services.costcalculationservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://localhost:8080/SOAProject/services/CostCalculationService","RepairTime").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://localhost:8080/SOAProject/services/CostCalculationService","NumberOfParts").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://localhost:8080/SOAProject/services/CostCalculationService","BikePart").equals(reader.getName())){
                                    ...
                                    list4.add(localhost.soaproject.services.commontypes.BikePartType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone4){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://localhost:8080/SOAProject/services/CostCalculationService","BikePart").equals(reader.getName())){
                                                                    list4.add(localhost.soaproject.services.commontypes.BikePartType.Factory.parse(reader));
