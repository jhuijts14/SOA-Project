                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                           ...
                                           localRepairTime.serialize(new javax.xml.namespace.QName("http://www.example.org/BikeInspectionService","RepairTime"),
                                               xmlWriter);
                                        
                                    namespace = "http://www.example.org/BikeInspectionService";
                                       ...
                                       if (localBikePart!=null){
                                            for (int i = 0;i < localBikePart.length;i++){
                                                if (localBikePart[i] != null){
                                                 localBikePart[i].serialize(new javax.xml.namespace.QName("http://www.example.org/BikeInspectionService","BikePart"),
                                                           xmlWriter);
                                                } else {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"InspectionResultsType".equals(type)){
                                ...
                                return (InspectionResultsType)org.example.www.bikeinspectionservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.example.org/BikeInspectionService","RepairTime").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.example.org/BikeInspectionService","NumberOfParts").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.example.org/BikeInspectionService","BikePart").equals(reader.getName())){
                                    ...
                                    list4.add(org.example.www.commontypes.BikePartType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone4){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://www.example.org/BikeInspectionService","BikePart").equals(reader.getName())){
                                                                    list4.add(org.example.www.commontypes.BikePartType.Factory.parse(reader));
