 ...
 */
            ...
            /**
            *  NotifyPickUp bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NotifyPickUp
    ...
    public static class Factory{
        ...
        */
        public static NotifyPickUp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NotifyPickUp object =
                new NotifyPickUp();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"NotifyPickUp".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NotifyPickUp)org.djbikeshop.www.customerservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
