...
/**
    ...
    public class CustomerServiceSkeleton implements CustomerServiceSkeletonInterface{
         ...
         * 
                                     * @param deliveryNotification0 
             * @return  
         */
        
                 public void notifyDelivery
                  (
                  org.djbikeshop.www.customerservice.DeliveryNotification deliveryNotification0
                  )
            {
                //TODO : fill this with the necessary business logic
                	// Retrieve the information from the request message;
                 	String customerName = deliveryNotification0.getDeliveryNotification().getCustomerName().getFirstName() 
                 			+ " " + deliveryNotification0.getDeliveryNotification().getCustomerName().getLastName();
                 	
                 	String delivDetails = deliveryNotification0.getDeliveryNotification().getDeliveryDetails().getTransportationTimeType().getTime() + "";
                 	
                 	
                // Simulate the notification of the pick up date time by printing the following;
                      System.out.println("===============================================================");
                      System.out.println("Hello " + customerName + "!");
                      System.out.println("Your bike will be picked up on " + delivDetails + ".");
                      System.out.println("===============================================================");
