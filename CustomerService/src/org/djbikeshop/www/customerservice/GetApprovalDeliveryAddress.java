...
/**
 * GetApprovalDeliveryAddress.java
 *
 ...
 */
            ...
            /**
            *  GetApprovalDeliveryAddress bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetApprovalDeliveryAddress
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetApprovalDeliveryAddress",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetApprovalDeliveryAddress",
    ...
    public static class Factory{
        ...
        */
        public static GetApprovalDeliveryAddress parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetApprovalDeliveryAddress object =
                new GetApprovalDeliveryAddress();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetApprovalDeliveryAddress".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetApprovalDeliveryAddress)org.djbikeshop.www.customerservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
