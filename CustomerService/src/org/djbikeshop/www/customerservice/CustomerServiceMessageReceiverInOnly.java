 ...
 */
        ...
        */
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("notifyDelivery".equals(methodName)){
            
            org.djbikeshop.www.customerservice.DeliveryNotification wrappedParam = (org.djbikeshop.www.customerservice.DeliveryNotification)fromOM(
                                                        inMessage.getEnvelope().getBody().getFirstElement(),
                                                        org.djbikeshop.www.customerservice.DeliveryNotification.class,
                                                        getEnvelopeNamespaces(inMessage.getEnvelope()));
                                            
                                                     skel.notifyDelivery(wrappedParam);
